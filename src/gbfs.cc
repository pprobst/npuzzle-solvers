...
GBFS::GBFS(Heuristic h) { this->heuristic = h; }
 ...
 *
 * Best-First Search algorithms expand the "most promising" nodes according to
 * some heuristic. GBFS is the same as A*, but with a different comparator (does
 * not consider g+h, or F).
 */
